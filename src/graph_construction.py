...
def make_group_graph(connectomes, k=8, self_loops=False, symmetric=True):
    ...
    self_loops: bool, default=False
        Whether or not to keep self loops in graph, if set to False resulting adjacency matrix
        has zero along diagonal.
    symmetric: bool, default=True
        Whether or not to return a symmetric adjacency matrix. In cases where a node is in the neighbourhood
